...
/*
 * Type definition for a function that gets the current time in milliseconds
 */
typedef uint32_t (*shell_tick_get_t)(void);
 ...
 * @param tick_get The callback function used to get the current time in milliseconds.
